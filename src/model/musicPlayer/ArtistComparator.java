...
public class ArtistComparator implements Comparator<Song>{
	 ...
	 * @param s1 The Song that will compare its artist with the Song s2 artist lexicographically<br>s1 != null
	 * @param s2 The Song that will be compared with Song s1 artist lexicographically<br>s2 != null
