...
public class AlbumComparator implements Comparator<Song>{
	 ...
	 * @param s1 The Song that will compare its album with the Song s2 album lexicographically<br>s1 != null
	 * @param s2 The Song that will be compared with Song s1 album lexicographically<br>s2 != null
